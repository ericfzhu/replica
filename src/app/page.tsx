	...
	return (
		<main className="flex min-h-screen flex-col items-center gap-24 bg-white p-24">
			<section className="flex flex-col items-center gap-12">
				<h1 className="max-w-4xl flex-wrap text-center text-4xl text-black">
				...
				<div className="flex gap-2">
					<Link
						...
						className="rounded-full border-[1px] border-accent-500 bg-accent-500 px-4 py-2 text-white duration-300 hover:bg-accent-400">
						Code
					</Link>
					<Link
